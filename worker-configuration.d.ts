/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 71c3cd3fbde3d468c5f714d2afd9b1cf)
// Runtime types generated with workerd@1.20250508.0 2025-05-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		ASANA_DISCORD_CHANNEL_MAP: KVNamespace;
...
declare namespace NodeJS {
	interface ProcessEnv
		extends StringifyValues<
			Pick<Cloudflare.Env, "BASE_URL" | "ASANA_BEARER" | "DISCORD_TOKEN">
		> {}
}
